...
# publicamos comandos en: <STUDENT_ID>/autopilotServiceDemo/<command>
TOPIC_PREFIX_PUB = f"{STUDENT_ID}/autopilotServiceDemo"
# telemetría viene en: autopilotServiceDemo/<STUDENT_ID>/telemetryInfo
TOPIC_TELEMETRY_SUB = f"autopilotServiceDemo/{STUDENT_ID}/telemetryInfo"
...
# --- MQTT client setup ---
mqtt_client = mqtt.Client(client_id=f"http_gateway_{STUDENT_ID}")
# Si tu broker requiere username/password:
# mqtt_client.username_pw_set("user", "pass")

def on_connect(client, userdata, flags, rc):
    print("MQTT conectado con rc =", rc)
    # Suscribirse a telemetría específica para este STUDENT_ID
